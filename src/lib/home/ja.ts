...
export const homeJa: HomeCopy = {
  metaTitle: "DeTars | 一行、放り込むだけ。あとは走り切る。",
  metaDescription:
    "一度のチャットでは終わらない、あなたの用事のために。使い慣れたチャットアプリから一行渡せば、DeTarsは自分で何時間も動き、仕上がった成果を持って戻ってくる。",
  heroEyebrow: "本当の仕事をこなす、あなた専用のAI",
  heroH1: "DeTarsに一行、放り込むだけ。<span class='grad'>あとは走り切る。</span>",
  heroSub: "一度のチャットでは終わらない、あなたの用事のために。",
  heroPrimary: "目標をひとつ渡す →",
  heroSecondary: "どう働くかを見る",
  proof: [
    { n: "数時間", l: "付きっきり不要 · 一晩中でも" },
    { n: "~50", l: "の最前線モデル · いつでも切替" },
    { n: "100%", l: "知ったことはあなたのマシンの中" }
  ],
  verify: "· ここにあるものはすべて、あなたのマシンで確かめられる——スライドの修辞ではない",
  hookKicker: "なぜ、今なのか",
  ...
  liveKicker: "それと暮らす",
  liveH2: "一行を送る。<span class='o'>仕上げて戻ってくる。</span>",
  steps: [
    { st: "どこからでも入力", sd: "Telegram / Slack / Feishu——一行、または一枚の写真で(WeChatはテキストのみ)" },
  ...
  bombCap: "行のファーストパーティコード · 2026年6月7日時点",
  bombH2: "ハードな仕事をこなせると「言う」のではない——<span class='o'>それは、自分自身を生み出した。</span>",
  bombP:
    "<b>2026年6月7日</b>時点で、DeTars自身のコードベースには <b>gitが追跡するファーストパーティの .ts/.tsx が 4,889ファイル・1,175,104行</b>あった(vendorの依存と生成された .d.ts は除外。別勘定のvendorランタイムは加算していない)。正直な限定を添える:このコードは<b>DeTars自身のagent harness上で、人が主導して</b>書かれたものであり、AIが無人で走り切ったものではない。頼りにならないエンジンから、この規模の動くアプリは出てこない——そしてこの数字は、その場でコードベースから数えられる。",
